...
# make a line graph of sub metering variables and save as a png file
png(file="plot3.png")
with(powersub, 
     plot(datetime2, Sub_metering_1, 
                    xlab = "",
                    ylab = "Energy sub metering",
                    type="n"))
lines(powersub$datetime2, powersub$Sub_metering_1)
lines(powersub$datetime2, powersub$Sub_metering_2, col="red")
lines(powersub$datetime2, powersub$Sub_metering_3, col="blue")
